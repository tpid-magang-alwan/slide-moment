...
export default function Footer() {
  return (
    <footer id="Contact" className="flex items-center justify-between w-full bg-[#eeeeee] shadow-inner py-3 px-4 sm:px-10 md:px-24 text-[#0C0202] transition-all duration-300">
      {/* Kiri: Copyright */}
